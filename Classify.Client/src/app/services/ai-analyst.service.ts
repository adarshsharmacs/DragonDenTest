...
export class AiAnalystService {
    ...
    private roleFaqs: { [key: string]: FAQItem[] } = {
        'Judges': [
            ...
            { question: 'What is the financial impact of this issue?', answer: 'By addressing this challenge, we have the opportunity to unlock approximately $300k in annual high-value productivity. Redirecting technical capacity from manual discovery and impact analysis to solution delivery will not only improve the efficiency and effectiveness of our development process, but also enhance solutioning as developers and QAs can dedicate more time to innovation and quality.' },
